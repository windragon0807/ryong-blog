    ...
    <div ref={wrapperRef} className="relative">
      ...
      {open ? (
        <div
          ...
          role="dialog"
          aria-label="환경설정 패널"
          className="absolute right-0 top-[calc(100%+0.55rem)] z-50 w-[min(92vw,22rem)]"
        >
          <div className="rounded-2xl border border-zinc-200/90 bg-white/95 p-3 shadow-[0_24px_60px_-30px_rgba(20,20,30,0.55)] backdrop-blur-xl dark:border-zinc-700/80 dark:bg-zinc-900/95">
            ...
            <div className="mt-2 grid gap-2.5">
              <section className="rounded-xl border border-zinc-200/80 bg-zinc-50/85 p-3 dark:border-zinc-700/70 dark:bg-zinc-800/70">
